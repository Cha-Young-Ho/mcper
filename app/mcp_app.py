...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "(3) get_global_skill(app_name='확인된_값', origin_url='...') 호출 — 스킬 로드 및 SKILL FILE 블록을 지정 경로에 저장. "
        ...
        "Skills(스킬)는 시스템 구조·패턴 파악에 활용한다. 적용 우선순위: Rules 위반 확인 → Skills 맥락 파악 → 사용자 요청 수행. "
