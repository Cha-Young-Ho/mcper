...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "get_workflow_mermaid_tool(scope, section_name, version, app_name, pattern) 로 특정 버전의 Mermaid 다이어그램 텍스트 조회. "
        "set_workflow_mermaid_tool(scope, section_name, version, mermaid, app_name, pattern) 로 Mermaid 업로드 (제자리 업데이트). "
        "Mermaid 생성은 'workflow-to-mermaid' 스킬 참고. "
